...
### {mp-06.01 mp %!s(int=6) %!s(int=1)}: Review, Approve, Track, Document, and Verify
...
### {mp-06.02 mp %!s(int=6) %!s(int=2)}: Equipment Testing
...
### {mp-06.03 mp %!s(int=6) %!s(int=3)}: Nondestructive Techniques
